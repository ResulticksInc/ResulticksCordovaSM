...
+ (void)initWithApiWithApiKey:(NSString * _Nullable)apiKey registerNotificationCategory:(NSSet<UNNotificationCategory *> * _Nonnull)category SWIFT_METHOD_FAMILY(none);
...
@interface REiosHandler (SWIFT_EXTENSION(REIOSSDK))
+ (void)addEventWithEventName:(NSString * _Nullable)eventName data:(NSString * _Nullable)data;
+ (void)updateLocationWithLat:(NSString * _Nullable)lat long:(NSString * _Nullable)long_;
@end
